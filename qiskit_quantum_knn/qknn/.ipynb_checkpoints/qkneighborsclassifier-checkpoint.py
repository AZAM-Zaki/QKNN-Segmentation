...
class QKNeighborsClassifier(QuantumAlgorithm):
    ...
    def construct_circuit(state_to_classify: np.ndarray,
        ...
        """
        QuantumCircuit = qc.construct_circuit(
            state_to_classify,
            oracle,
            add_measurement
        )
        print("Bentuk dari circuit yang digunakan adalah \n",QuantumCircuit.draw())
    ...
    def construct_circuits(data_to_predict,
        ...
        logger.info("Done.")
        print("Yeay, Circuit constructed!")
    ...
    def get_circuit_results(self,
        ...
        print("Sedang Mengeksekusi circuit")
    ...
    def calculate_fidelities(counts: Dict[str, int]) -> np.ndarray:
        ...
        """
        print("Calculate the fidelities")
